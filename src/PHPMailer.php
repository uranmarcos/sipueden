...
class PHPMailer
{
    ...
    protected function sendmailSend($header, $body)
    {
        ...
        // MODIFICO POR VERSION DE PHP el siguiente if, agregando una variable:
        // if (empty($this->Sender) && !empty(ini_get('sendmail_from'))) {
        //     //PHP config has a sender address we can use
        //     $this->Sender = ini_get('sendmail_from');
        // }
        $sendmail_from = ini_get('sendmail_from');
        if (empty($this->Sender) && !empty($sendmail_from)) {
            // PHP config has a sender address we can use
            $this->Sender = $sendmail_from;
        }
        // END MODIFICO POR VERSION DE PHP el siguiente if, agregando una variable:
